  ...
  <div class="application-container">
    <div class="application-row">
        <div class="application-image-wrapper">
            ...
            <h2><a href="{{ url('/vajra-qc-20') }}">Vajra QC 20</a></h2>
        </div>
        <div class="application-image-wrapper">
            <img src="images/home-img.jpg" alt="Image 2">
            <h2><a href="{{ url('/vajra-qc-65') }}">Vajra QC 65</a></h2>
        </div>
        <div class="application-image-wrapper">
            <img src="images/home-img.jpg" alt="Image 3">
            <h2><a href="{{ url('/vajra-qc-100') }}">Vajra QC 100</a></h2>
        </div>
    </div>
    <div class="application-row">
        <div class="application-image-wrapper">
            <img src="images/home-img.jpg" alt="Image 1">
            <h2><a href="{{ url('/marak-pl-70') }}">Marak PL 70</a></h2>
        </div>
        <div class="application-image-wrapper">
            <img src="images/home-img.jpg" alt="Image 2">
            <h2><a href="{{ url('/darsh') }}">Darsh</a></h2>
        </div>
        <div class="application-image-wrapper">
            <img src="images/home-img.jpg" alt="Image 3">
            <h2><a href="{{ url('/ajeya-vt-80') }}">Ajeya VT 80</a></h2>
        </div>
    </div>
</div>
  <div class="letusknow">
