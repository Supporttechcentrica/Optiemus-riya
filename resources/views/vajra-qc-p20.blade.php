 ...
 <section class="hero-20">
  ...
  <div class="container mt-5 hero-below-section">
    <div class="row align-items-center">
      ...
      <div class="col-md-6">
        <img src="{{ asset('images/vajra-20/vajra-qc-20-second.png') }}" class="img-fluid rounded" alt="Technology Image" />
      </div>
    </div>
  </div>
  ...
  <section class="parameters" style="background-color: #f0f0f0">
    <h1>Parameters</h1>
    <img src="{{ asset('images/vajra-20/vajra-parameters.png') }}" />
  </section>
  ...
  <div class="page-wrapper" id="pageWrapper">
    <div class="threecontainer" onclick="openPopup()">
      <div class="image-container">
        <img class="threeimage" src="{{ asset('images/360dronearrow.png') }}" alt="Three View Image" style="width:200px;height:200px;">
      </div>
    </div>
  </div>
    ...
    <div class="news">
      <div class="gallery">
        <section class="gallery_items active">
          <video autoplay muted src="{{ asset('media/video/Waypoint Based Navigation.mp4') }}"></video>
        </section>
        <section class="gallery_items">
          <video muted src="{{ asset('media/video/Terrain Avoidance.mp4') }}"></video>
        </section>
        <section class="gallery_items">
          <video muted src="{{ asset('media/video/Target Tracking.mp4') }}"></video>
        </section>
        <section class="gallery_items">
          <video muted src="{{ asset('media/video/Target Indicator.mp4') }}"></video>
        </section>
        <section class="gallery_items">
          <video muted src="{{ asset('media/video/Swarm Attack.mp4') }}"></video>
        </section>
        <section class="gallery_items">
          <video muted src="{{ asset('media/video/Remote Video Terminal.mp4') }}"></video>
        </section>
        <section class="gallery_items">
          <video muted src="{{ asset('media/video/Kamikaze Attack.mp4') }}"></video>
        </section>
        <section class="gallery_items">
          <video muted src="{{ asset('media/video/High Wind Resistance.mp4') }}"></video>
        </section>
        <section class="gallery_items">
          <video muted src="{{ asset('media/video/Be on Track.mp4') }}"></video>
        </section>
        <section class="gallery_items">
          <video muted src="{{ asset('media/video/Anti Jamming.mp4') }}"></video>
        </section>
      </div>
    </div>
  ...
  <div class="section-conatiner-div">
    <section class="section-container">
      ...
      <div class="image-container">
        <img src="{{ asset('images/vajra-20/vajra-qc-20-second.pngimages') }}" alt="Tall Drone Image"
          style="height:300px;">
      </div>
    </section>
  </div>
