...
@section('content')
 ...
 <section class="hero-agri16">
    <div class="hero-content">
      <h1 style="font-weight: 600; color: #ffffff">Agri Shakti 16-L</h1>
  ...
  <div class="container mt-5 hero-below-section">
    <div class="row align-items-center">
      ...
      <div class="col-md-6">
        <img src="{{ asset('images/agri15-2nd.png') }}" class="img-fluid rounded" alt="Technology Image" />
        <script>
  ...
  <div class="section-conatiner-div">
    <section class="section-container">
      ...
      <div class="image-container">
        <img src="{{ asset('images/agri16-brochure.png') }}" alt="Tall Drone Image" style="height:300px;">
      </div>
    </section>
  </div>
