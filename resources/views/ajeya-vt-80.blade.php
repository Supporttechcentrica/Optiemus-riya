...
@section('content')
    ...
    <section class="hero-ajeya-80">
        <div class="hero-content">
            <h1 style="font-weight: 600; color: #ffffff">Ajeya VT-80</h1>
            <p>Long Endurance | Extended Operations Range | Payload Drop Ready</p>
        </div>
    </section>
    ...
    <div class="container mt-5 hero-below-section">
        <div class="row align-items-center">
            <div class="col-md-6">
                <p class="custom">
                    Ajeya VT 8.0 is a long endurance drone. It is built specially for extended operational range and is
                    payload drop ready. With payload capacity of upto 2.5 kgs and cruise speed of 15 m/s, the Ajeya VT
                    8.0 comes with hot swappable EO/IR Cameras.
                </p>
            </div>
            <div class="col-md-6">
                <img src="images/Iso.15.png" class="img-fluid rounded" alt="Technology Image" />
                <script>
  ...
  <script>
    ...
    <div class="section-conatiner-div">
        <section class="section-container">
            ...
            <div class="image-container">
                <img src="images/Back.17.png" alt="Tall Drone Image" style="height:300px;">
            </div>
        </section>
    </div>
