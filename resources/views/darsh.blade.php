...
@section('content')
   ...
   <section class="hero-darsh">
        <div class="hero-content">
            <h1 style="font-weight: 600; color: #ffffff">Darsh</h1>
            <p>Quick Deployment | Long Range Surveillance aiding Infantry Operations</p>
        </div>
    </section>
    ...
    <div class="container mt-5 hero-below-section">
        <div class="row align-items-center">
            <div class="col-md-6">
                <p class="custom">
                    Darsh is specially designed for Long Range Surveillance aiding Infantry Operations. As it can be
                    quickly deployed into action, Darsh saves precious minutes that are of great significance during a
                    military operation. It is EMI (Electro Magnetic Interference) and EMC (Electro Magnetic
                    Compatibility) hardened, thus making it an ideal choice. It is also convertible for Kamikaze
                    operations.
                </p>
            </div>
            <div class="col-md-6">
                <img src="images/darsh-1st.png" class="img-fluid rounded" alt="Technology Image" />
                <script>
    ...
    <section class="parameters" style="background-color: #f0f0f0">
        <h1>Parameters</h1>
        <img src="images/DARSH specification.png" />
    </section>
  ...
  <script>
    ...
    <div class="section-conatiner-div">
        <section class="section-container">
            ...
            <div class="image-container">
                <img src="images/darsh-front.png" alt="Tall Drone Image" style="height:300px;">
            </div>
        </section>
    </div>
